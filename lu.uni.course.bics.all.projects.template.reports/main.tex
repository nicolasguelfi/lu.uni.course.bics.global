...
Describe in this section the main knowledge supposed to be formerly known by you and that is useful to remind in order to understand the remaining parts of your report.
Do not include presentation of technologies or scientific concepts that belong to an objective of your BSP since it must be described in the section \ref{sec-production}. Thus all the content of this section is not considered as a deliverable
\subsection{Scientific background}
\subsection{Technical background}

\section{ A Scientific Deliverable 1}
For each scientific deliverable targeted in section~\ref{sec-deliverables} provide the subsections described below.
...
For each technical deliverable targeted in section~\ref{sec-deliverables} provide the subsections described below.
