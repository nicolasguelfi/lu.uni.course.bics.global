...
\footnote{a tutor is not a co-author per se for a student work. It is possible that you will exploit your BSP report to produce a scientific and technical publication. In this case, you'll discuss the authors list with the concerned parties (remove this footnote after having read it).}
...
\footnote{this paragraph, not counting in the total words quantity, must be included in the submitted report but this footnote has to be removed.} I declare that I am aware of the following facts:
\begin{itemize}
