...
\footnote{remove this footnote after having read it - a tutor is not a co-author per se for a student work. It is possible that you will exploit your BSP report to produce a scientific and technical publication. In this case, you'll discuss the authors list with the concerned parties.}
...
\section{Plagiarism score}
{\Huge 0\%}
Indicate here the plagiarism score provided 
