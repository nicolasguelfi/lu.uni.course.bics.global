...
\title{BSP Project Description: <PROJECT_TITLE>\\
...
This template is to be used using the Latex document preparation system or using any document preparation system. The whole document should be 1500 words ($\pm$ 500 words)~\footnote{i.e. approximately 3 pages double columns excluding the Plagiarism Statement} for S2 to S6 students and 3000 words ($\pm$ 500 words) for S1 students (excluding the annexes) and the proportions must be preserved. The other documents to be delivered (summaries, \ldots) should have their format adapted from this template.\\
...
The authors would like to thank the BSP education team for the amazing work done.
